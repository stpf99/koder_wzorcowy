...
class ImageCoder(QMainWindow):
    ...
    def init_ui(self):
        ...
        self.test_cases_button = QPushButton("Generuj przypadki testowe")  # New button
        ...
        layout.addWidget(self.test_cases_button)  # Add new button to layout
        ...
        self.test_cases_button.clicked.connect(self.generate_test_cases)  # Connect new button
    ...
    def generate_test_cases(self):
        # Generate 8x8 test case image
        self.image_height, self.image_width = 8, 8
        size = self.image_height * self.image_width

        # List of test cases
        test_patterns = [
            ("all_black", lambda: np.ones((8, 8), dtype=int)),  # All black (1s)
        ...
        # Cycle through test cases (for simplicity, rotate each click)
